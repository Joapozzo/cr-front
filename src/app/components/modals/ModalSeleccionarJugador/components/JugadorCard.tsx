...
interface JugadorCardProps {
    ...
    isSelected: boolean;
    onSelect: (jugadorId: number) => void;
}

/**
 * Componente presentacional para la card de un jugador
 * No sabe qué hace al click, solo emite onSelect
 */
export const JugadorCard = ({ jugador, isSelected, onSelect }: JugadorCardProps) => {
    return (
        <button
            onClick={() => onSelect(jugador.id_jugador)}
