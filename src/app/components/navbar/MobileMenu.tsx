        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-[var(--gray-400)] p-4">
            <Link
              href="/logout"
              onClick={onClose}
              className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-400 hover:text-red-300 transition-all duration-200 group"
            >
