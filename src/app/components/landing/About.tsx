                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-[var(--black-900)] p-6 rounded-xl border border-[var(--black-800)] shadow-xl hidden md:block">
                                <p className="text-4xl font-bold text-[var(--color-primary)] mb-1">2016</p>
                    ...
                    >
                        <h2 className="text-2xl md:text-5xl font-bold text-[var(--white)] mb-6">
                            ...
                            <span className="text-[var(--color-primary)]">una comunidad</span>
                        </h2>
                        <p className="text-[var(--gray-100)] text-base md:text-lg mb-6 leading-relaxed">
                            Desde 2016, {tenant.nombre_empresa} ha sido el punto de encuentro para los amantes del fútbol en Córdoba. Lo que empezó como un pequeño torneo de amigos, hoy es una de las ligas más competitivas y organizadas de la ciudad.
                        </p>
                        ...
                        {/* <div className="border-l-4 border-[var(--color-primary)] pl-6 py-2 bg-[var(--black-900)]/50 rounded-r-lg">
                            ...
                            <p className="text-[var(--color-primary)] font-bold mt-2 text-sm">— Martín G., Capitán de &quot;Los Pibes FC&quot;</p>
                        </div> */}
                    </motion.div>
                </div>
            </div>
