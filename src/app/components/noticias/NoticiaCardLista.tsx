...
export const NoticiaCardLista: React.FC<NoticiaCardListaProps> = ({ noticia }) => {
  ...
  return (
    ...
    >
      <div className="bg-[var(--black-900)] border border-[#262626] rounded-xl overflow-hidden hover:border-[var(--color-primary)] transition-all duration-300 h-full">
        <div className="flex flex-col sm:flex-row gap-0 sm:gap-4">
          ...
          <div className="flex-1 p-4 flex flex-col justify-between">
            ...
            <div className="space-y-2">
              <h3 className="text-white font-semibold text-sm sm:text-base line-clamp-2 group-hover:text-[var(--color-primary)] transition-colors">
                {noticia.titulo}
              </h3>
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-[#262626]">
              ...
              {/* Botón "Leer más" */}
              <span className="text-[var(--color-primary)] text-xs font-medium group-hover:underline">
                Leer más →
              </span>
            </div>
          </div>
