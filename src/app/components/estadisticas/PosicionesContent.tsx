...
import { usePosicionesLive } from '@/app/hooks/usePosicionesLive';
...
function PosicionesContentInner() {
  ...
  // Obtener id_zona del primer elemento si existe
  const idZona = posicionesData && posicionesData.length > 0 ? posicionesData[0].id_zona : null;
  usePosicionesLive(idZona, categoriaId);
