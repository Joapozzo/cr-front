...
import { useEquipoCategorias, useEquipoCapitanes } from '@/app/hooks/legajos/useEquipos';
import { EquipoCapitanesTab } from '@/app/components/legajos/equipos/EquipoCapitanesTab';
import Skeleton, { SkeletonTheme } from 'react-loading-skeleton';
import 'react-loading-skeleton/dist/skeleton.css';

const EquipoCapitanesPageContent = () => {
...
export default function EquipoCapitanesPage() {
    return (
        <Suspense
            fallback={
                <div className="bg-[var(--gray-400)] rounded-lg border border-[var(--gray-300)] p-6">
